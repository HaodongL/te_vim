...
source(paste0(repo_path, "R/0_config.R"))
...
df_vte <- df_vte %>% mutate(across(where(is.numeric), round, 6))
...
# plotpath = paste0("~/Repo/te_vim/tnp/plot")
# ggsave('plot_theta_diab.png', width = 14, height = 8,
#        plot = p_theta_all, path = plotpath)
```
...
df_em <- fit_em_summary %>% mutate(across(where(is.numeric), round, 6))
df_em <- df_em[,2:7]
...
p_theta_all
# plotpath = paste0("~/Repo/te_vim/tnp/plot")
# ggsave('plot_theta_diab2.png', width = 14, height = 8,
#        plot = p_theta_all, path = plotpath)
```
...
# plotpath = paste0("~/Repo/te_vim/tnp/plot")
# ggsave('plot_theta_cv.png', width = 14, height = 8,
#        plot = p_theta_all, path = plotpath)
```
...
# plotpath = paste0("~/Repo/te_vim/tnp/plot")
# ggsave('plot_theta_a1c.png', width = 14, height = 8,
#        plot = p_theta_all, path = plotpath)
```
