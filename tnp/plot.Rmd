...
data_long <- rbind(data_long12 %>% mutate(Q_g_model = 'T, no CV'), 
                   data_long14 %>% mutate(Q_g_model = 'DR, CV'))

data_long <- rbind(data_long14 %>% mutate(Q_g_model = 'ranger'))
...
data_long <- data_long12 %>% mutate(Q_g_model = case_when(Method == 'SS-HAL' ~ 'HAL',
                                                          TRUE ~ 'Earth'))
...
data_long <- data_long12 %>% mutate(Q_g_model = 'HAL')
