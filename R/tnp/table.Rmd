...
# output_filename <- paste0('~/Repo/te_vim/simu_res/theta_s/temp/','local_earth_', N, "_", '2022-10-07','.csv')
# res <- read_csv(output_filename) %>% mutate(n = 5e3)
```
